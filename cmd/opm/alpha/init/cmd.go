...
func NewCmd() *cobra.Command {
	...
	cmd.Flags().StringVarP(&init.IconFile, "icon", "i", "", "Path to package's icon")
	cmd.Flags().StringVarP(&init.DescriptionFile, "description", "d", "", "Path to the operator's README.md (or other documentation)")
